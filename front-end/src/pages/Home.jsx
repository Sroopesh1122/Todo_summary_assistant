    ...
    <>
      <section className="w-full min-h-screen p-5 font-outfit">
        <article className="w-full flex justify-between items-center">
          <span className="text-[1.5rem] font-semibold relative flex justify-center items-center gap-2">
            Todo Summary Assitant{" "}
            <span className="absolute w-[60px] h-[60px] -z-10 bg-yellow-400 rounded-full -top-2 -left-2"></span>{" "}
            <img
              src="https://img.freepik.com/premium-photo/chat-bot-with-wave-hand-using-smartphone-stock-smart-robot-technology-rendering-3d-png-format_1257429-76599.jpg"
          ...
          <span
            className="p-2 bg-yellow-400 rounded-md flex justify-center items-center gap-1 cursor-pointer"
        ...
        <section className="w-full flex flex-col-reverse md:flex-row justify-start gap-2 items-start mt-[50px]">
          <section className="w-full md:w-[70%] rounded-2xl p-5 shadow">
            <article className="w-full flex justify-end items-center">
              <button
                className="bg-black text-white px-2 py-1 rounded-2xl cursor-pointer"
            ...
            {TODO_LIST?.length === 0 ? (
              ...
              <section className="w-full min-h-[50vh] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mt-[10px]">
          ...
          <section className="w-full md:w-[30%] min-h-[50vh] shadow-md rounded-2xl">
            <h1 className="bg-yellow-400 text-[1.4rem] font-semibold text-center py-3 rounded-tl-2xl rounded-tr-2xl">
              Summary Overview
            </h1>

            {
              ...
              <button className="bg-black text-white text-[0.95rem] cursor-pointer rounded-lg py-2 px-3" onClick={()=>getSummaryMutation.mutate()}>
              ...
              {({ handleBlur, handleChange }) => (
                <Form className="mt-[20px] w-full">
                  ...
                  <article className="w-full mt-[20px] flex justify-center items-center">
                    <button className="w-[80%] rounded-xl bg-yellow-400 py-2 cursor-pointer flex justify-center items-center gap-2">
...
const TODO_CARD = ({ data }) => {
  ...
  return (
    <>
      <div className="w-full p-5 h-fit bg-white border border-yellow-400 rounded-2xl shadow">
        ...
        <h1 className="mt-[20px] text-[0.9rem] text-gray-800">
          ...
          {completed ? (
            ...
            <span className="text-[0.8rem] border border-orange-400 p-[3px] ms-2 text-orange-400 rounded-full">
              Pending
            </span>
          )}
        </h1>
        ...
        <div className="w-full flex justify-end items-center gap-1 mt-[20px]">
          {
            ...
            className="text-[0.9rem]  p-1 bg-yellow-400 rounded-xl cursor-pointer flex justify-center items-center gap-1"
          >
          ...
          <button
            ...
            className="text-[0.9rem] p-1 bg-black text-white rounded-xl cursor-pointer flex justify-center items-center gap-1"
          >
